...
<head>
    ...
    <title> Pilih Peran | SIM KKN</title>
            ...
            <div class="authentication-inner py-6">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mb-6 form-control-validation row">
                            <label for="email" class="form-label">Pilih Peran</label>
                            <?php foreach ($_SESSION['jabatan_list'] as $row): ?>
                                <form class="col-12 mb-2" action="<?= BASE_URL ?>/Auth/selectJabatan" method="POST">
                                    <input type="hidden" name="nama_jabatan" value="<?= $row['nama_jabatan'] ?>">
                                    <button type="submit" class="btn btn-primary w-100"
                                        value="<?= $row['id_jabatan'] ?>"
                                        name="id_jabatan"><?= $row['nama_jabatan'] ?></button>
                                </form>
                            <?php endforeach; ?>
                        </div>
