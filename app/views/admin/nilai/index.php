                ...
                <tbody>
                    ...
                    foreach ($data['kelompok'] as $row):
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?= BASE_URL ?>/Nilai/show/<?= htmlspecialchars($row['id']) ?>"
                                    class="btn btn-info"><i class="ti tabler-eye me-1"></i> Detail</a>
                                <form action="<?= BASE_URL ?>/Token/generate/<?= htmlspecialchars($row['id']) ?>"
                                    method="post" class="d-inline">
                                    <button type="submit" class="btn btn-primary"><i
                                            class="ti tabler-file-settings me-1"></i> Generate Token</button>
                                </form>
                            </td>
                        </tr>
                    <?php endforeach; ?>
